...
NexT.utils = {
  ...
  registerSidebarTOC: function() {
    ...
    const sections = [...navItems].map(element => {
      ...
      var target = document.getElementById(decodeURI(link.getAttribute('href')).replace('#', '')); ///add
      // TOC item animation navigate.
      link.addEventListener('click', event => {
        event.preventDefault();
        /// del var target = document.getElementById(event.currentTarget.getAttribute('href').replace('#', ''));
      ...
      /// del return document.getElementById(link.getAttribute('href').replace('#', ''));
      return target;
    });
